        ...
        <div className="container mx-auto xs:mt-0 mt-7"  id='contact' >
         ...
         text-secondary uppercase tracking-wider  mt-16">FIND ME ON</h1>
                ...
                <div className="flex justify-center gap-8 mb-20 mt-8 ">
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/sharjeel-iftikhar-0x53" target="_blank">
                            <svg xmlns="https://www.linkedin.com/in/sharjeel-iftikhar-0x53" className="h-7 w-7 cursor-pointer dark:text-white"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
